...
#define M1_PIN 13   // front-left,  spins CCW
#define M2_PIN 14   // front-right, spins CW
#define M3_PIN 27   // rear-left,   spins CW
#define M4_PIN 26   // rear-right,  spins CCW
...
const int ESC_MIN = 1000; // microseconds, motor off / idle
const int ESC_MAX = 2000; // microseconds, full throttle
